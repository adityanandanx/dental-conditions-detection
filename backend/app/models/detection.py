...
DEFAULT_DISCLAIMER = (
    "This report is generated by an automated system for informational "
    "purposes only. It is not a medical device and does not constitute a "
    "diagnosis. All findings must be reviewed and confirmed by a licensed "
    "dental professional before any clinical decision is made."
)
...
class DiagnosticReport(BaseModel):
    ...
    severity_level: SeverityLevel = Field(
        description="Overall severity assessment (low, moderate, high, none)"
    )
